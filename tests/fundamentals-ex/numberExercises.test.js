import {
  checkIfIsInteger,
  checkIfNumberIsInfinite,
  checkIfNumbIsDivisibleByThree,
  checkVariable,
  divide,
  multiply,
  subtract,
  sum,
} from "../../src/fundamentals-ex/numberExercises";
